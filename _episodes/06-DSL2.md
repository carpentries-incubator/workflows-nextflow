...
- "What is DSL2"
objectives:
- "Understand what DSL2 is"
keypoints:
- "DSL2 is an extension to DSL that makes to modularise workflows "
---


Nextflow provides a syntax extension, DSL2, that  makes it possible to scale and modularise your data analysis pipeline 
 while continuing to use the Dataflow programming paradigm that characterises the Nextflow processing model.
